...
> **CROSSED — 2026-08-31, the keeper's mark: *"lets commit those 8, and assemble the
...
>
> **DEVELOPED — 2026-08-31, on the keeper's instruction ("run a full development at
...
> independent verify. The eight crystals are unchanged — they are the keeper's
...
**2 · THE MARK IS THE ONLY CROSSING** — nothing binds except by the keeper's own
...
Strongest sighting: the keeper's mark 2026-08-16, verbatim in `ORGANS.json`: *"I
...
Strongest sighting: the keeper's words, NESI.md's closing section: *"I do the
...
- **Recurrence detects habit as reliably as merit.** The corpus itself proved
  ...
  reliably as these eight — and the keeper suspended it wholesale on 2026-08-15 as
  debris. Recurrence proposes; the mark disposes. The eight below bind
  because the keeper crossed them, not because they recurred.
...
- **Missing crystal:** something real ships that none of the eight accounts
  ...
  sightings and put to the keeper's felt read.
...
**Held on the keeper's mark, 2026-08-31** (*"what if there are actually 12
...
1. *Count as output* — exactly twelve structures earn seats by the standing
   bar (3+ verified sightings, seated by the keeper's felt read), with no pass
...
direction" · the CAST gesture-seat: "I GIVE IT AWAY" · the keeper's deposit
...
*First assembled 2026-08-31, two passes. Crossed the same day, the keeper's mark.
