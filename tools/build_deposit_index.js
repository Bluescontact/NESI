...
<header>
  ...
  <h1>NESI</h1>
  <p class="lede">NESI is a small browser game about writing and reflection — no login, no score, nothing sent anywhere. This repository has the game, and the design material behind it, assembled onto a spine of principles ("nucleation points") that recurred through every version of the work — so you can see not just where each piece came from, but why it was kept.</p>
...
<h2 id="spine">The spine — ${CRYSTALS.length} nucleation points</h2>
