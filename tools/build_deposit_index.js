...
<header>
  ...
  <h1>NESI</h1>
  <p class="lede">Three rooms. <b>The game</b> — a small browser surface for writing and reflection; no login, nothing sent anywhere; open it and write. <b>The house</b> — the finished, usable things: pick one up and something happens. <b>The workshop</b> — the making, kept honestly in the open: the doctrine, the patterns, the gate and pipeline and weave, and the records of how it was all made. The spine — eleven principles the work kept arriving at — is the frame the whole building stands on.</p>
