...
/* ── the faces and the centre ─────────────────────────────────────────────────
   Added 2026-08-16 with the keeper's ruling "the centre is the game." Every line here
...
/* ── the eight faces ──────────────────────────────────────────────────────────
   The keeper's instruction 2026-08-16: "site the eight mechanics on the eight
   triangles." FACES.json holds the assignment.

   ■ RETIRED, 2026-08-21, same pass ascent.html was rebuilt from scratch on
   The keeper's mark ("cut the ascent entirely"). This block checked that
...
/* ── the container's motion, and the frame it is measured in ──────────────────
   The keeper's instruction 2026-08-16: "arrange them into the scaffold for the
...
/* ── the interior: 26 positions the surface never showed ──────────────────────
   The keeper, 2026-08-16: "map the 26 positions." Twelve radii, eight tetrahedral
...
/* -- what each pyramid cell DOES: the six trades ------------------------------
   The keeper, 2026-08-16: "now assign function to the 6 pyramid cells." The function
...
/* ── THE KEEPER'S RULING, 2026-08-16: "twelve radials, two to each pair — 36 stands."
