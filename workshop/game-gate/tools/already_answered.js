#!/usr/bin/env node
/* ═══ ALREADY ANSWERED ═════════════════════════════════════════════════════════
 * Built 2026-08-16 on the keeper's standing instruction:
 *   "find rather then ask for as many of the open positions as possible. The keeper's
...
const ZONES = [
  ...
  { w: 3, name: "the memory",      roots: [path.join(HOME, ".claude", "projects", "<corpus-slug>", "memory")] },
