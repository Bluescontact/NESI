#!/usr/bin/env node
/* ═══ THE LIBRARY LENS ═══════════════════════════════════════════════════════
 * Built 2026-08-27, the keeper's instruction: "build a lens to extract anything
 ...
 * session — or the keeper — to read the real file and confirm it before
...
const ROOTS = [
  ...
  // NESI v2's organ body — the keeper's mark 2026-08-31: v2 and world3d both
  ...
  // The fresh walk, 2026-08-31 (the keeper's mark: "run a fresh scan on
  // territory the lens hasn't walked"). ROOT below is NESI's parent —
  // the corpus root. Chosen deliberately: territories the keeper has named as
...
function main() {
  ...
  lines.push("");
  lines.push("Built on the keeper's instruction 2026-08-27: \"build a lens to extract anything");
