 ...
 * no standing to rule it; that is the keeper's, named and held open, same as any
 ...
 * the keeper's mark ("cut the ascent entirely"). The three constants this file
...
/* ═══ S5 · seam.js growRoot — ROOT_STEP=0.22, days to visible standing ═════ */
{
  ...
  report("S5 note — standing crosses 0.5 on day " + (firstMeaningful || "never within 15") +
    ...
    ". Whether that pace is right is the keeper's read, not this instrument's — reported for his eye, not ruled on.");
}
