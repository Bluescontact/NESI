...
const NODE = [
  ...
  /* kit_check, constraint_lint, first_four, cut_check, conserve_stations,
     ...
     ascent.html was rebuilt from scratch (the keeper's mark: "cut the ascent
  ...
  /* REGISTERED 2026-08-17 on the keeper's "close all three gaps", after the trim-tab
  ...
  /* REGISTERED 2026-08-17 on the keeper's mark, "build the truth-bearing spine
  ...
  /* REGISTERED 2026-08-17 on the keeper's mark, "traversal is a fourth source — add
  ...
  /* REGISTERED 2026-08-17 on the keeper's mark, "build the traversal organ." It
  ...
  /* REGISTERED 2026-08-17 on the keeper's "build the instrument first", after he read
  ...
  /* REGISTERED 2026-08-19, threshold-sweep's first run (see the two
     ...
     (the keeper's fork, never defaulted here) and REFUSES only where a
  ...
  /* REGISTERED 2026-08-20 on the keeper's mark, closing a fact-lens gap the
  ...
  /* REGISTERED 2026-08-25 on the keeper's mark, "build all three," closing a gap a
     reconciliation pass named: "only the keeper's click marks land in a marks
...
/* THE PREDICATE FILTER, REGISTERED 2026-08-16 on the keeper's "save the filter to be
...
/* THE GATE, REGISTERED 2026-08-17 on the keeper's mark, "wire it into check_all."
