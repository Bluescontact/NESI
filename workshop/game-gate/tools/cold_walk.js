 ...
 *
 * DEMOTED 2026-08-12 on the keeper's order: "The builder's cold-walk script demotes to pre-check.
 * The verdict walk is run by a walker who did not write the build." a held-back lens agent found the
 ...
 *
 * WHAT ONLY A NON-BUILDER MAY RETURN: the verdict. The keeper's own hand, or a walker who did not
 * write the build. Until then the standing word is UNWITNESSED.
 *
 * the keeper's ruling, 2026-08-12 (process jurisdiction): a standing instrument and a GATE.
...
(() => {
  ...
  /* ---- C7 · EVERY ROOM NAMES ITSELF, AND NAMES ITSELF AND NOT THE ONE BEFORE ----
     The keeper's ruling, 2026-08-12: the locator is always present. The fault this catches is
  ...
  /* ---- C8 · THE TENSION MEMBER — a first sentence must be SEEN to land ----
     The keeper's order, 2026-08-12: act and consequence co-visible at t=0. The check is not
