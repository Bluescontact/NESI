...
//
// the keeper's mark, 2026-08-31: "lets commit those 8, and assemble the deposits
...
// its one-line why, and the keeper's felt read outranks every line of it.
...
const CRYSTALS = [
  ...
  { id: 'c2', name: 'the mark is the only crossing',
    line: 'nothing binds except by the keeper’s own mark, and supersession is a layer on top, never an erasure' },
...
const SEATS = {
  ...
  // Imported from soil through the gate, 2026-08-31 (the keeper: "continue
  ...
  'converger_capture':                       { crystal: 'c2', why: 'authorship machine-checkable: verbatim, source must be the keeper, anything else refused' },
  // THE TEN ORGANS (the keeper: "bring forward and prepare the 10 organs for
  ...
  // The ROS_RI staged block (the keeper: "work the ROS_RI staged block") —
  ...
  // Batch 1 of the reading-pass queue (the keeper: "run batch 1") — the
  ...
  // Batch 2 of the reading-pass queue (the keeper: "run batch 2") — the
  ...
  // Batch 3 of the reading-pass queue (the keeper: "run batch 3") — the
  ...
  // Batch 4 (the keeper: "strip other peoples names. batch four needs to be
...
// mark. Found by the 2026-08-31 deposit audit (the keeper's mark: "inventory,
