 ...
 *
 * Built 2026-08-31, on the keeper's own correction to lens_usage_check.js:
 * "there are unarticulated processes... The keeper uses the 7 with one mention."
 ...
 * cloned into the geometry of the keeper's actual development process" checks
 * against.
 *
...
// pull in every OTHER project the keeper has ever worked in.
const PROJECT_SLUGS = [
  "<corpus-slug>",
  "<corpus-slug>",
];
