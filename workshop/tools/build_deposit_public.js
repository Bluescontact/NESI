...
// the same day (the keeper's mark), both now real mining roots, not just named.
...
function main() {
  ...
  // 2026-08-31 audit (the keeper's mark: "inventory, audit, and reform what's
  ...
  for (const rel of admittedRootPaths) {
    ...
    // The spine (the keeper's mark 2026-08-31: "assemble the deposits onto
  ...
  // of thing it is (THE TYPOLOGY: organ/nutrient/lens/seed/pollen — the keeper's
  ...
  // Move 2, the keeper's mark 2026-08-31: skills/agents promote on real
  ...
  // the seed itself does not (the keeper's crossing to make, not the pipeline's)
  ...
  // Agents: NOT promoted, regardless of invocation count. The keeper's mark,
  ...
  // copy (the keeper's marks 2026-08-31: the agents ruling + "lets remove
  // the keeper from the work"); the count and the reason cross, the names stay
