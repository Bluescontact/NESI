#!/usr/bin/env python3
"""
NESI CONTINUITY v0 — the persistence layer, so Kevin stops being it.
...
Nothing here is operated and nothing here asks Kevin to feed it — if a
change makes Kevin maintain continuity by hand, it broke the gift.
...
def derive(core_state: dict) -> dict:
    """Resume-state, all derived — nothing authored, nothing asked of Kevin."""
    open_threads = []
