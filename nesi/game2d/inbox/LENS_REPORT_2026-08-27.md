...
- **world3d/.walk/_snapshot/scripts/intake/deposit.gd** — score 6 (6238b, has a def, claims built/works)
  > ## THE DEPOSIT — the day's writing becomes stones in the shared store. ## ## THIS AUTHORS NO NEW PATH. The chain already exists and was closed on Kevin's ## mark 2026-08-02: a sentence -> `nesi_world_stones` -> `export/web/stones.json`
...
- **world3d/.walk/_snapshot/scripts/river.gd** — score 6 (13215b, has a def, claims built/works)
  > # THE RIVER AND THE DAM — sited on the grain, never by hand. # # Kevin's ruling, 2026-08-05, verbatim: # "SITE THE DAM AND THE RIVER ON THE GRAIN: the river runs where the ground # already falls (valleys cut along bedding), and the dam
...
- **world3d/.walk/_snapshot/scripts/sorting_tarp.gd** — score 6 (12886b, has a def, claims built/works)
  > # THE SORTING TARP — the first articulation-free instrument in this world. # # Kevin's brief, 2026-08-06, verbatim and load-bearing: # # "if each space has a worksurface and tools... if objects and their uses are # apparent by shape an
