#!/usr/bin/env node
/* ═══ THE ROUTE MAP ════════════════════════════════════════════════════════════
 * Built 2026-08-16 on Kevin's order, before a new GitHub repo is handed over:
 ...
 * the repository. `.gitignore` carries a staged-worktree scoping (Kevin's mark,
 ...
 * and it is meant to fall as Kevin routes, never as this file gets cleverer.
 *
 * @seat none
...
L(`  ${unrouted.length} of ${MAP.length}. This number is the work; it falls when Kevin routes, not when this file gets cleverer.`);
