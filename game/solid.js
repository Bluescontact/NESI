/* ═══ THE SOLID ═══════════════════════════════════════════════════════════════
   ...
   ── RULED, 2026-08-18, the keeper's mark ────────────────────────────────────────
...
/* ── THE THREE OUTPUTS ────────────────────────────────────────────────────────
   ...
   and send it nowhere. The keeper's mark 2026-08-14 extends this to the tank, which
   ...
   THIS PASS LEAVES IT STANDING. The keeper's, not this file's.
   ───────────────────────────────────────────────────────────────────────────── */
...
/* ═══ THE FACES AND THE CENTRE ════════════════════════════════════════════════
   Added 2026-08-16 on the keeper's line: "the centre is the game. everything else
...
/* ── THE RIGIDITY OF THE CONTAINER ────────────────────────────────────────────
   ...
   CONFIRMED INDEPENDENTLY, 2026-08-16, on the keeper's instruction. PyRigi 1.3.0
...
/* ═══ THE CENTRE — the frame, not a place in it ═══════════════════════════════
   The keeper's ruling 2026-08-16: "the centre is the game. everything else serves it."
...
/* ═══ THE INTERIOR — 26 positions the surface never showed ════════════════════
   The keeper, 2026-08-16: "there are volumes, edges, and points within the solid that
...
/* ── TWELVE RADII, and what one is FOR ────────────────────────────────────────
   The keeper, 2026-08-16: "now assign function to the 12 radii."
...
/* ── WHAT A PYRAMID CELL DOES — its function, derived ─────────────────────────
   The keeper, 2026-08-16: "now assign function to the 6 pyramid cells."
